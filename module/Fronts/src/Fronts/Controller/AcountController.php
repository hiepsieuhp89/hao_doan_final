    ...
    public function registerAction() {
        ...
        if ($this->request->isPost()) {
            ...
            if ($check) {
                ...
                $title_mail = 'Whaale.store | Thông báo Quý Khách hàng  đã đăng ký thành công tài khoản mua hàng mới';
                $content_mail = '<p style="font-weight:bold">Xin chào bạn, ' . $name . '</p>
                               <p>Thông tin tài khoản của bạn tại <span style="font-weight:bold">Whaale.store</span></p>
    ...
    public function resetpassAction() {
        ...
        if ($this->request->isPost()) {
            ...
            if ($check) {
                ...
                $title_mail = 'Whaale.store | Khôi phục mật khẩu';
                $content_mail = '<p>Bạn vừa sử dụng tính năng khôi phục mật khẩu Website <a href="' . WEB_PATH . '"><span style="font-weight:bold">Whaale.store</span></a></p>
                    <p style="font-weight:bold"> Mật khẩu mới của bạn là: ' . $pass . '</p>
                    <p>Để bảo mật tài khoản của bạn hãy đăng nhập Website <a href="' . WEB_PATH . '"><span style="font-weight:bold">Whaale.store</span></a> để đổi mật khẩu của bạn</p>';
                $this->sendmail($email, $email_admin, $title_mail, $content_mail);
